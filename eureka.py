...
for article in articles:
	...
	if len(article) >= 4:
		...
		mot = article[1].split()[4]

	print "L'article que vous regardez a été publié par " + media + " dans la section " + section + ". L'article a " + mot + " mots et apparaît à la " + page + "."

for article in articles:

	article = article.split(",")

	article1.append(article[0])

leSoleil = article1.count("Le Soleil")
laPresse = article1.count("La Presse+")
laTribune = article1.count("La Tribune")
leNouvelliste = article1.count("Le Nouvelliste")
laVoix = article1.count("La Voix de l'Est")
leDevoir = article1.count("Le Devoir")

print ""
print "Le Soleil a publié " + str(leSoleil) + " articles."
print "La Presse + a publié " + str(laPresse) + " articles."
print "La Tribune a publié " + str(laTribune) + " articles."
print "Le Nouvelliste a publié " + str(leNouvelliste) + " articles."
print "La Voix de l'est a publié " + str(laVoix) + " articles."
print "Le Devoir a publié " + str(leDevoir) + " articles."